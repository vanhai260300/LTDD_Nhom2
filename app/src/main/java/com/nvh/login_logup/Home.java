...
import com.nvh.login_logup.Fragment.FragmentAdapter;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Viewlipper kiểu như slideShow (CÒn quá cùi cần Upgrade)
    ...
    //Load menu khi nhấn giữ Item GridView
    @Override
    ...
    //Load danh sách sẩn phẩm lên GridView
